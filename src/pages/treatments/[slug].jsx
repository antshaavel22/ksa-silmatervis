  ...
  return (
    <Layout>
      <Head>
        ...
        />
        <meta name="keywords" content={`${page.title}, treatment, eye care, KSA`} />
        <meta property="og:title" content={`${page.title} - Silmatervis`} />
        <meta property="og:description" content={page.description} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://silmatervis.ksa.ee/treatments/${page.slug}`} />
      </Head>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-700 mb-6">
              Our ophthalmologists can help determine the best treatment approach for
...
export async function getStaticProps({ params }) {
  const page = pilotPages.find(
    (p) => p.slug === params.slug && p.category === 'treatments'
  );
...
export async function getStaticPaths() {
  const paths = pilotPages
    .filter((p) => p.category === 'treatments')
    .map((page) => ({
